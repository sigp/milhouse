...
- `ProgressiveList/Rebase/SelectedConditions.lean` proves the general public
  ...
  `rebase_success_iff_requirements`. At a fixed packing layout, selected input
  requirements are necessary and sufficient, plus the actual pending-map
  clone's termination for nonmutating rebase. No whole-tree shape or
...
Latest selected-geometry checkpoint (`2d63438`, foundations `15af31a`,
