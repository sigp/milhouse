...
- `ProgressiveList/ApplyUpdates/Overlay.lean` proves exact representation
  ...
  the all-branch result requires backing/layout/range/maximum laws only on
...
Latest apply-updates overlay checkpoint (`8e80e9c`, success criteria
