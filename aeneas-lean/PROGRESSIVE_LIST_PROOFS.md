...
- `Vec/Clone.lean` recovers actual optional slot clones from a successful
  ...
  standard Lean axioms. Propagating identity necessity to progressive/list
  materialization remains unfinished; the public existence criteria still
  assume retained/pending clone identity.
...
Latest apply-updates clone-identity checkpoint:
