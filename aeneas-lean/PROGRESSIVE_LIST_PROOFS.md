...
- `ProgressiveTree/BulkUpdate/Density.lean` derives density from a numeric
  ...
  The lower proofs are `f0daba3`; public integration is `aa023cf`. Content
  preservation, materialization, and total sequence contracts still use the
  semantic maximum law to justify skipped pending values; that premise
...
Latest apply-updates maximum-premise checkpoint (`aa023cf`, lower proofs
