...
- `Tree/Rebase/Kind.lean` classifies inputs using the actual pointer, element,
  ...
  `b7e16e2`). The original-cache refinements are recorded above. Remaining
  assumption review is separate work; no general necessity theorem for the
  complete cache contract is claimed.
...
Latest original-cache checkpoint (`01f0d4f`, foundations `a653121`, `8173c77`):
