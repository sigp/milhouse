...
- `Tree/Rebase/Kind.lean` classifies inputs using the actual pointer, element,
  ...
  `b7e16e2`). The original-cache premises and remaining assumption review are
  separate work; no general necessity theorem for the complete cache contract
  is claimed.
...
Latest binary base-cache checkpoint (`99fad96`, foundation `b7e16e2`): focused
