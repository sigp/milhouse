...
- `Tree/BulkUpdate/Skipped.lean` permits a pending value in a range
  ...
  existence criteria: binary execution and backing-density arguments still
  use it. Scope/routing is `79282b8`, generalized contents `7a2235e`, binary
...
Latest apply-updates binary skipped-value checkpoint:
