...
- `ProgressiveList/Rebase/Conditions.lean` proves `rebase_on_success_iff`
  ...
  termination criteria under the stated geometry, not a necessity result for
  the geometry itself. The public checkpoint is `d5836d4`, with foundations
  `3f2f4fa`, `c3ff39d`, and `212ac40`.
...
Latest rebase success-conditions checkpoint (`d5836d4`, foundations `3f2f4fa`,
