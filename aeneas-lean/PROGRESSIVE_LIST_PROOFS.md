...
- `ProgressiveList/Rebase/Ready.lean` proves `rebase_on_success_iff_ready`
  ...
  and geometry laws for content/cache correctness and model fidelity remain
  separate obligations. The public/integration checkpoint is `3231f6f`, with
...
Latest packing-query checkpoint (`3231f6f`, foundations `d1ba797`, `4952ade`,
