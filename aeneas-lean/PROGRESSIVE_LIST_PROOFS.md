...
- `Tree/HashCache.lean` and `Tree/ProgressiveTree/HashCache.lean` describe
  ...
  preservation contract, not yet a proof of semantic hash computation or cache
  initialization by every constructor/mutation.
...
Latest constructor and reconstruction cache checkpoint (through `26a1117`):
