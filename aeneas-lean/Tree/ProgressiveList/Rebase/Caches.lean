...
clones, or representation assumption are required. Original validity covers
retained caches and base validity covers imported caches, as selected by the
binary actions in reached progressive layers. -/
theorem ProgressiveList.rebase_on_cache_spec {T U : Type}
    ...
    (hselfCache : self.tree.RebaseOrigCachesOn ValueInst.corecmpPartialEqInst P base.tree 0) (hbaseCache : self.tree.RebaseBaseCachesOn ValueInst.corecmpPartialEqInst P base.tree 0)
