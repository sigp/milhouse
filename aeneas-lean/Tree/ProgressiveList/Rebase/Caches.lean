...
clones, or representation assumption are required. Base validity covers only
the caches selected by binary actions in reached progressive layers. -/
theorem ProgressiveList.rebase_on_cache_spec {T U : Type}
    ...
    (hselfCache : self.tree.CachesOn P 0) (hbaseCache : self.tree.RebaseBaseCachesOn ValueInst.corecmpPartialEqInst P base.tree 0)
